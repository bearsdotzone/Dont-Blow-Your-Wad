...
function lib_toPropertyKey(t) { var i = lib_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function lib_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
function findFairyMultiplier(familiar) {
  ...
  if (familiar === $familiar(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["Jill-of-All-Trades"])))) return 1.5;
...
function property_toPropertyKey(t) { var i = property_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
...
function combat_toPropertyKey(t) { var i = combat_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function combat_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
function combat_isNativeFunction(fn) { try { return Function.toString.call(fn).indexOf("[native code]") !== -1; } catch (e) { return typeof fn === "function"; } }
...
function dist_combat_toPropertyKey(t) { var i = dist_combat_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function dist_combat_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
function logger_toPropertyKey(t) { var i = logger_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function logger_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
function maximize_toPropertyKey(t) { var i = maximize_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function maximize_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
function outfit_toPropertyKey(t) { var i = outfit_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function outfit_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
function engine_toPropertyKey(t) { var i = engine_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function engine_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
;// ./src/util.ts
var util_templateObject, util_templateObject2;
...
function getCurrentCrimboWad(html) {
  var knownCrimboWads = ["hot", "cold", "spooky", "stench", "sleaze"];
  var imgRegex = /<img[^>]+>/gi;
  var match;
  while ((match = imgRegex.exec(html)) !== null) {
    ...
    var titleMatch = /title=['"]([^'"]+)['"]/i.exec(imgTag);
    var name = ((altMatch === null || altMatch === void 0 ? void 0 : altMatch[1]) || (titleMatch === null || titleMatch === void 0 ? void 0 : titleMatch[1]) || "").toLowerCase().trim();
    var wadType = name.replace(/\s+wad$/, "");
...
var WAD_TYPES = ["hot", "cold", "spooky", "stench", "sleaze"];
function wadValueFromPulverize(p, wadPrice, wadType) {
  var _p, _p2, _p3;
  if (!p) return 0;
  return ((_p = p["".concat(wadType, " wad")]) !== null && _p !== void 0 ? _p : 0) * wadPrice / 1000000 + ((_p2 = p["".concat(wadType, " nuggets")]) !== null && _p2 !== void 0 ? _p2 : 0) * wadPrice / 5 / 1000000 + ((_p3 = p["".concat(wadType, " powder")]) !== null && _p3 !== void 0 ? _p3 : 0) * wadPrice / 25 / 1000000;
}
function fetchPricegunItem(item) {
  try {
    var text = (0,external_kolmafia_namespaceObject.visitUrl)("https://pricegun.loathers.net/api/".concat(item.id));
...
function pricegunValue(item) {
  var data = fetchPricegunItem(item);
  if (!data || !data.value || data.value <= 0) return null;
  return data.value;
}
var pricegunCache = new Map();
function pricegunPrice(item) {
  if (!pricegunCache.has(item)) {
    pricegunCache.set(item, pricegunValue(item));
  }
  return pricegunCache.get(item);
}
function results(wadTypes) {
  var _pricegunPrice;
  var twinklyMall = (0,external_kolmafia_namespaceObject.mallPrice)(template_string_$item(util_templateObject || (util_templateObject = util_taggedTemplateLiteral(["twinkly wad"]))));
  var twinklyPricegun = (_pricegunPrice = pricegunPrice(template_string_$item(util_templateObject2 || (util_templateObject2 = util_taggedTemplateLiteral(["twinkly wad"]))))) !== null && _pricegunPrice !== void 0 ? _pricegunPrice : twinklyMall;
  var mallWadPrices = new Map(wadTypes.map(w => [w, (0,external_kolmafia_namespaceObject.mallPrice)((0,external_kolmafia_namespaceObject.toItem)("".concat(w, " wad")))]));
  var pricegunWadPrices = new Map(wadTypes.map(w => {
    var _pricegunPrice2;
  ...
  var wadResults = external_kolmafia_namespaceObject.Item.all().filter(i => (0,external_kolmafia_namespaceObject.toSlot)(i) !== external_kolmafia_namespaceObject.Slot.none).map(item => {
    ...
    var mallValue = 0;
    var pricegunValue = 0;
    var _iterator = util_createForOfIteratorHelper(wadTypes),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var _mallWadPrices$get, _pricegunWadPrices$ge;
        var wadType = _step.value;
        mallValue += wadValueFromPulverize(p, (_mallWadPrices$get = mallWadPrices.get(wadType)) !== null && _mallWadPrices$get !== void 0 ? _mallWadPrices$get : 0, wadType);
        pricegunValue += wadValueFromPulverize(p, (_pricegunWadPrices$ge = pricegunWadPrices.get(wadType)) !== null && _pricegunWadPrices$ge !== void 0 ? _pricegunWadPrices$ge : 0, wadType);
      }
    ...
    mallValue += ((_p$twinklyWad = p["twinkly wad"]) !== null && _p$twinklyWad !== void 0 ? _p$twinklyWad : 0) * twinklyMall / 1000000 + ((_p$twinklyNuggets = p["twinkly nuggets"]) !== null && _p$twinklyNuggets !== void 0 ? _p$twinklyNuggets : 0) * twinklyMall / 5 / 1000000 + ((_p$twinklyPowder = p["twinkly powder"]) !== null && _p$twinklyPowder !== void 0 ? _p$twinklyPowder : 0) * twinklyMall / 25 / 1000000;
    pricegunValue += ((_p$twinklyWad2 = p["twinkly wad"]) !== null && _p$twinklyWad2 !== void 0 ? _p$twinklyWad2 : 0) * twinklyPricegun / 1000000 + ((_p$twinklyNuggets2 = p["twinkly nuggets"]) !== null && _p$twinklyNuggets2 !== void 0 ? _p$twinklyNuggets2 : 0) * twinklyPricegun / 5 / 1000000 + ((_p$twinklyPowder2 = p["twinkly powder"]) !== null && _p$twinklyPowder2 !== void 0 ? _p$twinklyPowder2 : 0) * twinklyPricegun / 25 / 1000000;
    var price = (0,external_kolmafia_namespaceObject.mallPrice)(item);
    if (price <= 0) return null;
    var mallNet = mallValue - price;
    var pgNet = pricegunValue - price;
  ...
  }).filter(o => o !== null).sort((a, b) => b.pgNet - a.pgNet); // sort by Pricegun by default
  var _iterator2 = util_createForOfIteratorHelper(wadResults),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var _step2$value = _step2.value,
        price = _step2$value.price,
        item = _step2$value.item,
        mallNet = _step2$value.mallNet,
        mallROI = _step2$value.mallROI,
        pgNet = _step2$value.pgNet,
        pgROI = _step2$value.pgROI;
      (0,external_kolmafia_namespaceObject.print)("For Item: ".concat(item, ": price: ").concat(price));
      (0,external_kolmafia_namespaceObject.print)("  mall:     net ".concat(mallNet.toFixed(0), " meat (ROI ").concat((mallROI * 100).toFixed(1), "%)"));
      (0,external_kolmafia_namespaceObject.print)("  pricegun: net ".concat(pgNet.toFixed(0), " meat (ROI ").concat((pgROI * 100).toFixed(1), "%)"));
      (0,external_kolmafia_namespaceObject.print)("");
    }
  } catch (err) {
    _iterator2.e(err);
  ...
  var out = "";
  var _iterator3 = util_createForOfIteratorHelper(wadResults),
    _step3;
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      var _step3$value = _step3.value,
        _price = _step3$value.price,
        _item = _step3$value.item;
      out += "mallbuy 1000 ".concat(_item, "@").concat(_price, ";");
    }
  } catch (err) {
    _iterator3.e(err);
  } finally {
...
var args = Args.create("Dont_Waste_Your_Wad", "Be good, be kind", {
  all: Args.flag({
...
function main(command) {
  ...
  var wadTypes;
  if (args.all) {
    wadTypes = main_toConsumableArray(WAD_TYPES);
  } else if (args.crimbo) {
    var html = (0,external_kolmafia_namespaceObject.visitUrl)("shop.php?whichshop=crimbo25_sammy");
    var todaysWad = getCurrentCrimboWad(html);
    if (!todaysWad) throw "Could not determine today's Crimbo wad!";
    wadTypes = [todaysWad];
  } else if (args.wad !== "") {
    if (!WAD_TYPES.includes(args.wad)) {
      throw "Invalid wad type \"".concat(args.wad, "\".");
    }
    wadTypes = [args.wad];
  } else {
